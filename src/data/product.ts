export default {
  ...
  - MAG SPEED just dev-dummy.s3.us-east-2.amazonaws.com/images/products/mouse3.jpg',
  ], WHEEL: Ultra-fast, precise, quiet MagSpeed electromagnetic scrolling
  - DARK FIELD 4000 DPI SENSOR: Dark field 4000 DPI sensor for precise tracking on any surface, even glass (up to 4mm in thickness)
